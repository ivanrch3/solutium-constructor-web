...
export const ModuleRenderer = ({ 
  ...
  const renderContent = () => {
    switch (module.type) {
      case 'top-bar':
        return <TopBarModule data={moduleData} isPreview={isPreview} />;
      case 'header':
        return <HeaderModule data={moduleData} modules={modules} isPreview={isPreview} onCTA={handleCTA} />;
      case 'hero':
      ...
      case 'footer':
        return <FooterModule data={moduleData} />;
