...
const SpecialEventLightbox: React.FC<{ image: StoryImage; onClose: () => void; onPrevious?: () => void; onNext?: () => void }> = ({ image, onClose, onPrevious, onNext }) => {
