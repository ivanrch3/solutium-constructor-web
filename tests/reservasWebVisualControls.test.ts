...
test('Reservas Web visual controls normalize safely and remain instance-isolated', () => {
  ...
  assert.match(markup, /#123456|rgb\(18, 52, 86\)/);
  assert.match(markup, /#111111|rgb\(17, 17, 17\)/);
