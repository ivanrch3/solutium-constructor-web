...
export const profileSchema = z.object({
  ...
  themePreference: z.any().optional().nullable(),
  preferredTheme: z.any().optional().nullable(),
  activeTheme: z.any().optional().nullable(),
  fontFamily: z.any().optional().nullable(),
  uiStyle: z.any().optional().nullable(),
  baseSize: z.any().optional().nullable(),
  borderRadius: z.any().optional().nullable(),
  sidebarBg: z.any().optional().nullable(),
  sidebarForeground: z.any().optional().nullable(),
  sidebarAccent: z.any().optional().nullable(),
  sidebarBorder: z.any().optional().nullable(),
  coloredSidebarIcons: z.any().optional().nullable(),
