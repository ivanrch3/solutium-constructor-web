...
const MODULE_ADAPTERS: Record<string, ModuleBridgeAdapter> = {
  ...
  hero: {
    contentToSettings: {
      ...
      'primary_url': 'el_hero_ctas_primary_url',
      'btn_url': 'el_hero_ctas_primary_url',
      'button_url': 'el_hero_ctas_primary_url',
      'cta_url': 'el_hero_ctas_primary_url',
      'primary_cta.type': 'el_hero_ctas_primary_link_type',
      'primary_cta.link_type': 'el_hero_ctas_primary_link_type',
      'secondary_cta.text': 'el_hero_ctas_secondary_text',
      'secondary_cta.url': 'el_hero_ctas_secondary_url',
      'secondary_url': 'el_hero_ctas_secondary_url',
      'secondary_cta.type': 'el_hero_ctas_secondary_link_type',
      'secondary_cta.link_type': 'el_hero_ctas_secondary_link_type',
