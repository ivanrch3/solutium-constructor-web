...
export const TeamModule: React.FC<{ 
  ...
  const members = userMembers.length > 0 ? userMembers : [
    { name: 'Alex Rivera', role: 'Director Creativo', bio: '10 años de experiencia en diseño.', image: 'data:image/svg+xml;base64,', category: 'Diseño', linkedin: '#', twitter: '#', web: '#' },
    { name: 'Elena Soler', role: 'Lead Developer', bio: 'Experta en arquitecturas escalables.', image: 'data:image/svg+xml;base64,', category: 'Ingeniería', linkedin: '#', twitter: '#', web: '#' },
    { name: 'Marc Costa', role: 'Estratega Digital', bio: 'Especialista en crecimiento de marca.', image: 'data:image/svg+xml;base64,', category: 'Marketing', linkedin: '#', twitter: '#', web: '#' }
  ];
